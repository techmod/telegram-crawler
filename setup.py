...
setup(
    ...
    author='Mohammad Narmestani',
    author_email='mohammadn1992@gmail.com',
    url='https://github.com/techmod/telegram-crawler',
    download_url='https://github.com/techmod/telegram-crawler/releases',
